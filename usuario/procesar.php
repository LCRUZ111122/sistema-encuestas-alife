<?php
	...
	$resultado10 = $connection->query($query10);
...
<body>
	...
	<center>
		...
		$resultado5 = $connection->query($query5);
		...
		if ($tamaño > 0) {
			...
			$resultado6 = $connection->query($query6);
