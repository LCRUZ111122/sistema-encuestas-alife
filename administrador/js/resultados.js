...
var elementosTamaño = document.getElementsByClassName("tamano");
if (elementosTamaño.length === 10) {
  
for (var x = 0; x < 2; x++) {
	var elementoTamaño = document.getElementsByClassName("tamano")[x];
	if (elementoTamaño && elementoTamaño.value) {
		c[x] = elementoTamaño.value;
		if (c[x] == 3) {
	...
	console.error("El numero de elementos con la clase 'tamano' no es igual a 10.");
  }
}
}